...
public class Owan_Group_Chat_Activity extends AppCompatActivity {
 ...
 private FirebaseRecyclerAdapter<ChatMessage, GroupChatViewHolder> mChatAdapter;
  private  LinearLayoutManager linearLayoutManager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Owan West");
        // Initializing Firebase Dependency
        String owan_west = getIntent().getStringExtra("owanwest");

        mAuth = FirebaseAuth.getInstance();
        user_id = mAuth.getCurrentUser().getUid();
        mGroupChat = FirebaseDatabase.getInstance().getReference().child("Group_Chat").child(owan_west);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mGroupChat.push().setValue(groupChatMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        Toast.makeText(Owan_Group_Chat_Activity.this,"message sent",Toast.LENGTH_SHORT).show();
                    }
                });
                mEdit.setText("");
