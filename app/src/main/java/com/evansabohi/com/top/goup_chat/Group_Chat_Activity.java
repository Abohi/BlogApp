 ...
 private FirebaseRecyclerAdapter<ChatMessage, GroupChatViewHolder> mChatAdapter;
  private  LinearLayoutManager linearLayoutManager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String nameofgroup = getIntent().getStringExtra("nameofgroup");
        getSupportActionBar().setTitle(nameofgroup);
        mAuth = FirebaseAuth.getInstance();
        user_id = mAuth.getCurrentUser().getUid();
        mGroupChat = FirebaseDatabase.getInstance().getReference().child("Group_Chat").child(nameofgroup);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mGroupChat.push().setValue(groupChatMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        Toast.makeText(Group_Chat_Activity.this,"message sent",Toast.LENGTH_SHORT).show();
                    }
                });
                mEdit.setText("");
